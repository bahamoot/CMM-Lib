...
info_msg "executing: $convert2annovar" 1>&2
...
info_msg "executing: $add_key_to_avdb"
...
info_msg "executing: $summarize_annovar"
...
info_msg "executing: $move_key_cmd"
eval $move_key_cmd
